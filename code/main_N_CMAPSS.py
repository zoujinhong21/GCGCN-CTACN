...
from Pre_N_CMAPSS import seed, data_generate, MyDataG
...
X_train, Y_train, X_test, Y_test = data_generate("N-CMAPSS_DS01-005.h5",add_lag=False)
...
training_dataset = MyDataG(x_train = X_train, y_train = Y_train )

test_dataset = MyDataG(x_train = X_test, y_train = Y_test)
...
# cuda_avail = False
model = CombinedModel(num_nodes=Nodes,
    in_features=1,
...
model_save_path = r"..\model_save_directory\N-CMAPSS\DS01"
